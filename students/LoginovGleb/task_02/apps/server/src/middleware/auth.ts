...
// Не требует авторизацию, но если заголовок Authorization передан — он обязан быть валидным.
// Нужен, чтобы публичные эндпоинты могли «понимать» пользователя (например, показывать неактивные формы модератору).
